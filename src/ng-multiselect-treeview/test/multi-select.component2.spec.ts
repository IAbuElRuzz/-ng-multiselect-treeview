...
import { IDropdownSettings } from '../src/multiselect-treeview.model';
import { MultiSelectTreeViewComponent } from '../src/multiselect-treeview.component';
...
class Ng2MultiSelectDropdownMultipleSelect {
    @ViewChild(MultiSelectTreeViewComponent) select: MultiSelectTreeViewComponent;
    cities = [
...
// https://github.com/IAbuElRuzz/ng-multiselect-treeview/issues/67
